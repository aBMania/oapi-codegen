// Package issue1900 provides primitives to interact with the openapi HTTP API.
//
...
// Pong1 defines model for Pong1.
type Pong1 struct {
	Pong1Prop1 string `json:"pong1_prop1"`
	Pong1Prop2 string `json:"pong1_prop2"`
}

// Pong2 defines model for Pong2.
type Pong2 struct {
	Pong2Prop1 string `json:"pong2_prop1"`
	Pong2Prop2 string `json:"pong2_prop2"`
}

// Pong3 defines model for Pong3.
type Pong3 struct {
	Pong3Prop1 string `json:"pong3_prop1"`
	Pong3Prop2 string `json:"pong3_prop2"`
}
